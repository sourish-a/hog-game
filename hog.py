...
def free_bacon(score):
	...
	if score<10:
		...
		first_val, second_val = score%10, score//10
		value = (second_val*2) - first_val
...
def is_swap(player_score, opponent_score):
	...
	abs1, abs2 = 0, 0
	if player_score<10:
		abs1 = abs(0-player_score)
	else:
		abs1 = abs((player_score//10)%10 - player_score%10)

	if opponent_score<10:
		abs2 = abs(0-opponent_score)
	else:
		abs2 = abs((opponent_score//10)%10 - opponent_score%10)
